...
-- {{{ LAUNCHER
    ...
    awful.key(
        { modkey }, "r",
        function () 
            awful.spawn("rofi -show run -theme solarized -font 'Caskaydia Cove 14' -icon-theme 'Papirus' -show-icons")
        end,
    ...
    awful.key(
        { modkey }, "w",
        function () 
            awful.spawn("rofi -show window -theme solarized -font 'Caskaydia Cove 14' -icon-theme 'Papirus' -show-icons")
        end,
